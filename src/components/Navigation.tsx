  ...
  return (
    <>
      ...
      {navigationConfig.links.length > 0 && (
        <div
          className={cn(
            'fixed inset-0 z-40 bg-white/95 backdrop-blur-xl transition-all duration-500 ease-out-cubic lg:hidden',
          ...
          <div className="flex flex-col items-center justify-center h-full gap-8">
            {navigationConfig.links.map((link, index) => (
              <a
                ...
                onClick={(e) => handleNavClick(e, link.href)}
                className={cn(
                  'text-4xl font-bold tracking-tight text-exvia-black transition-all duration-500 ease-out-quart hover:text-exvia-blue',
                  isMenuOpen
            ...
            {navigationConfig.contactLabel && (
              <AnimatedButton
                ...
                size="lg"
                className={cn(
                  'mt-8 transition-all duration-500 ease-out-quart shadow-lg shadow-exvia-blue/20',
