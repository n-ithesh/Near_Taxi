...
export function Testimonials({ isLoading = false }: { isLoading?: boolean }) {
  if (isLoading) {
    return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
             ...
             <div className="space-y-8">
               <div className="flex gap-1">
                 {[1, 2, 3, 4, 5].map(i => <Skeleton key={i} className="w-5 h-5" />)}
               </div>
               <Skeleton className="h-32 w-full" />
               <div className="pt-6 border-t border-exvia-border space-y-2">
