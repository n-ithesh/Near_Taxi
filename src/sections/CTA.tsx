...
export function CTA({ isLoading = false }: { isLoading?: boolean }) {
  if (isLoading) {
    return (
      <section className="relative w-full py-32 lg:py-48 overflow-hidden bg-neutral-900">
        <div className="relative z-10 container-large px-6 lg:px-12">
           <div className="max-w-3xl mx-auto text-center space-y-8 flex flex-col items-center">
             ...
             <div className="flex gap-4 mt-10">
               ...
               <Skeleton className="h-6 w-48 bg-white/10 self-center" />
             </div>
           </div>
        </div>
      </section>
