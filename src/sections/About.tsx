...
export function About({ isLoading = false }: { isLoading?: boolean }) {
  if (isLoading) {
    return (
        ...
        <div className="container-large px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-exvia-border">
                {[1, 2, 3].map((i) => (
            ...
            <div className="grid grid-cols-2 gap-4">
               <Skeleton className="aspect-[4/5] rounded-lg mt-8" />
